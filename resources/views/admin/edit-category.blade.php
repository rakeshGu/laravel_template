                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value="{{ $category->title }}" placeholder="Name">
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @if($category->image)
                                <img src="{{asset('upload/categories/'.$category->image)}}" alt="" srcset="" width="100">
                                @endif
                            </div>
                    </div>
